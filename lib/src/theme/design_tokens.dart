...
class DesignTokens {
  ...
  static const Color info = Color(
    0xFF4F6172,
  ); // Usando el medium gray para info
  ...
  static const Color darkOnBackground = Color(
    0xFFFFFFFF,
  ); // White on dark - máximo contraste
  static const Color darkOnSurface = Color(
    0xFFFFFFFF,
  ); // White on dark surface - mejor contraste
  static const Color darkOnSurfaceSecondary = Color(
    0xFFB0B0B0,
  ); // Gray para texto secundario
  static const Color darkBorder = Color(0xFF3A3A3A); // Dark border
  static const Color darkBorderLight = Color(0xFF2A2A2A); // Dark border light
